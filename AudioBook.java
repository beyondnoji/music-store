...
public class AudioBook extends AudioContent
{
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	{
		super.printInfo(); 
		System.out.println("Author: " + this.getAuthor() + " Narrator: " + this.getNarrator()); 
	}
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		// Iterate through the chapterTitles ArrayList and print the Titles 
	...
	{	
		...
		return super.equals(other) && this.getAuthor().equals(otherAudioBook.getAuthor()) && this.getNarrator().equals(otherAudioBook.getNarrator()); 
	}
