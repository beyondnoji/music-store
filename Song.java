...
public class Song extends AudioContent implements Comparable<Song> 
{
	...
	{
		super.printInfo();
		System.out.println("Artist: " + this.getArtist() + " Composer: " + this.getComposer() + " Genre: " + this.getGenre()
		);  
	}
	...
	{
		Song otherObj = (Song) other; 
		return super.equals(otherObj) && this.getComposer().equals(otherObj.getComposer()) && this.getArtist().equals(otherObj.getArtist());
	}
	...
	{	
		...
		// returns positive integer otherwise  
	}
}
